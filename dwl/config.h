...
static const char *fonts[]                 = {"Cascadia Mono NF:style=Bold:size=11"};
static const float rootcolor[]             = COLOR(0x000000ff);
/* This conforms to the xdg-protocol. Set the alpha to zero to restore the old behavior */
static const float fullscreen_bg[]         = {0.1f, 0.1f, 0.1f, 1.0f}; /* You can also use glsl colors */
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xe0f8cfff, 0x000000ff, 0x222222ff },
	[SchemeSel]  = { 0x000000ff, 0x306850ff, 0x306850ff },
...
static const char *raise_vol[] = { "wpctl", "set-volume", "@DEFAULT_SINK@", "5%+", NULL };
static const char *lower_vol[] = { "wpctl", "set-volume", "@DEFAULT_SINK@", "5%-", NULL };
